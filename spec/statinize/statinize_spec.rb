      ...
      context 'when invalid forced attribute' do
        ...
        it 'raises an error with proper message' do
          expect { subject }.to raise_error(
            ...
            'ValidationError: ' \
            'First_name should be String, found Integer instead, ' \
            'Last_name should be String, found Integer instead'
          )
        end
      end
      ...
      context 'when forced class' do
        ...
        it 'raises an error with proper message' do
          expect { subject }.to raise_error(
            Statinize::ValidationError,
            'ValidationError: ' \
            'First_name should be String, found Hash instead, ' \
            'Last_name should be String, found Integer instead, ' \
...
class ExampleClass
  ...
  statinize do
    ...
    attributes :age, type: Integer, presence: true, cast: true
  end
end
